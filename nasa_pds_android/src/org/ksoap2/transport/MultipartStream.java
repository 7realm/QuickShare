...
public class MultipartStream {
    ...
    public static interface ProgressListener {
         ...
         * @param pItems The number of the field, which is currently being read. (0 = no item so far, 1 = first item is
         *        being read, ...)
         */
     ...
     *
     * <p>
     * The boundary token of the nested stream is <code>required</code> to be of the same length as the boundary token
     * in parent stream.
     *
     * <p>
     ...
     *
     * <p>
     * Headers are returned verbatim to the input stream, including the trailing <code>CRLF</code> marker. Parsing is
    ...
    /**
     * <p>
     * Reads <code>body-data</code> from the current <code>encapsulation</code> and writes its contents into the output
     * <code>Stream</code>.
     *
     * <p>
    ...
    public boolean skipPreamble() throws IOException {
        ...
        try {
            ...
            // Read boundary - if succeed, the stream contains an encapsulation.
            return readBoundary();
    ...
    public static class MalformedStreamException
        extends IOException {
        /**  */
        private static final long serialVersionUID = -5678309322944732822L;
    ...
    public static class IllegalBoundaryException extends IOException {
        /**  */
        private static final long serialVersionUID = -4309381357548610463L;
    ...
    public class ItemInputStream extends InputStream {
        ...
        public int read() throws IOException {
            if (closed) {
                throw new IOException("Item skipped.");
            }
            if (available() == 0) {
                if (makeAvailable() == 0) {
                    return -1;
